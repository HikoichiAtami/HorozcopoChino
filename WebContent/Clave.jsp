                    ...
                    <div class="col-12">
                        ...
                        <%} %> 
                            ...
                            <div class="form-group font-weight-bold ">
                                ...
                                <input type="text" class="form-control" placeholder="Nombre Usuario" id="txtUsuario" name="usuario" required>
                            </div>
                            <div class="form-group font-weight-bold">
                                <label for="txtClave ">Nueva Contraseña</label>
                                <input type="password" class="form-control" id="txtClave" placeholder="Contraseña" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" name="clave" required>
                              </div>
                               <div class="form-group font-weight-bold">
                              ...
                              <div class="form-group text-center">
                                <button type="submit" id="cambioClave" class="btn btn-light ">Actualizar</button>
                              </div>
