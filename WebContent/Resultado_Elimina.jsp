            ...
            <div class="col-6 ">
                <div class="card  my-3 ">
                    <div class="card-body ">
                            ...
                            <form class="text-center" action="EliminarUsuario" method="post">
                            	<input type="hidden" name="usuario" value="<%= user.getNombreUsuario() %>">
                            	<button class="btn bg-patron text-light" type="Submit">Eliminar</button>
                            </form>
                        </div>
