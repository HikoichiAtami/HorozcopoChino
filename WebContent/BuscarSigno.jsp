    ...
    <div class="container">
        <div class="row justify-content-center mt-3">
            <div class="col-6 ">
                <div class="card  mt-3 ">
                    <div class="card-body ">
                            <h3 class="card-title">Buscar Signo</h3>
                            <form action="BuscaSigno" method="POST" class="" id="buscaSigno">
                                <div class="form-group font-weight-bold ">
                                    <label for="txtUsuario">
                                        Ingrese una fecha
                                    </label>
                                    <input type="text" class="form-control" placeholder="YYYY-MM-DD" id="txtUsuario" 
                                    name="year" required>
                                </div>
    
                                <div class="form-group text-center">
                                    <button type="submit" id="yearSearch" class="btn bg-patron text-light  ">Buscar</button>
                                </div>
                            </form>
                        </div>
     ...
     horoscopo = (HoroscopoDTO) request.getAttribute("horoscopo");
     String ok = "ok";
     if(ok.equalsIgnoreCase((String)request.getAttribute("true"))){
     	out.print("<div class=\"container\">");
      		out.print("<div class=\"row justify-content-center\">");                           		
				out.print("<div class=\"col-6\">");
					out.print("<div class=\"card my-3\">");
						out.print("<div class=\"card-body\">");
							out.print("<h3 class=\"card-title\">Su Signo es</h3>");
							out.print("<table class=\"table\">");
								out.print("<tr>");
									out.print("<th scope=\"row\" class=\"text-center horoscopo\">");
