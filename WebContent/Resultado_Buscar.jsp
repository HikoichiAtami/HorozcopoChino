...
<body class="">
    ...
    <% UserDTO usuario = (UserDTO) request.getAttribute("usuario");
                    ...
                    <div class="card-body ">
                            ...
                            <table class="table">
                                <tr>
                                    ...
                                    <% out.print("<td> " + usuario.getNombreUsuario() + "</td>"); %>
                                </tr>
                                <tr>
                                    <th scope="row">
                                        Nombre
                                ...
                                <tr>
                                    ...
                                    <% out.print("<td> " + usuario.getFechaNac() + "</td>"); %>
                                </tr>
                                <tr>
                                    <th scope="row">
                                        Signo
                                    </th>
                                    <% out.print("<td> " + horoscopo.getNombreSigno() + "</td>"); %>
                                </tr>
                            </table>
                        </div>
