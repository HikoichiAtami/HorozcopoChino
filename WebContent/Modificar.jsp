...
<% 
	UserDTO user = (UserDTO)request.getAttribute("funado");
            ...
            <div class="col-6 ">
                <div class="card  my-3 ">
                    <div class="card-body ">
                            ...
                            <form action="ModificarUsuario" method="POST" class="">
                            	<% if(alerta!=null){ %>
                            	<h3><%=alerta %></h3>
                            	<%} %>
                                <div class="form-group font-weight-bold ">
                                    ...
                                    <input type="hidden" value="<%= user.getNombreUsuario() %>" name="userName">
                                    <input type="text" class="form-control" id="txtUsuario" name="usuario" value="<%= user.getNombreUsuario() %>" required>
                                </div>
                                <div class="form-group font-weight-bold ">
                                    <label for="txtNombre">
                                        Nombre
                                    </label>
                                    <input type="text" class="form-control" id="txtNombre" name="nombre" value="<%= user.getNombre() %>" required>
                                </div>
                                ...
                                <div class="form-group font-weight-bold ">
                                    ...
                                    <input type="text" class="form-control" id="txtUsuario" name="pass" value="<%= user.getPassword()%>" required>
                                </div>
                                <div class="form-group font-weight-bold ">
                                    <label for="txtUsuario">
                                        FechaNac 
                                    </label>
                                    <input type="date" class="form-control" id="txtUsuario" name="fechaNac"  value="<%= user.getFechaNac()%>" required>
                                </div>
    
                                <div class="form-group text-center">
                                    <button type="submit" class="btn bg-patron text-light  ">Modificar</button>
                                </div>
                            </form>
                        </div>
