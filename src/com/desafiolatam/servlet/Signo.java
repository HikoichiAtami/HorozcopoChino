...
/**
 * Servlet implementation class Signo
 */
@WebServlet("/Signo")
public class Signo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			horoscopo = facade.SeleccionarHoroscopo(user.getFechaNac());
			request.setAttribute("horoscopo", horoscopo);
			RequestDispatcher rd = request.getRequestDispatcher("MiZodiaco.jsp");
